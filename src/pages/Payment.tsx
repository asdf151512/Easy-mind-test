...
<p><strong>免責聲明：</strong>此報告僅供參考，不能替代專業心理諮詢。如您感到嚴重的心理困擾，請及時尋求專業心理健康服務。</p>
      ...
      const { error } = await supabase
        ...
        .update({
          ...
          payment_session_id: `mock_payment_${Date.now()}`,
          ...
          <CardContent className="space-y-6">
            <div className="bg-gradient-to-r from-primary/10 to-purple-100 p-6 rounded-lg">
              ...
              <div className="flex items-end gap-2 mb-4">
                <span className="text-3xl font-bold text-primary">NT$ 299</span>
                <span className="text-lg text-muted-foreground line-through">NT$ 499</span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <div className="text-center space-y-4">
                ...
                >
                  ...
                  {isProcessing ? "處理中..." : "立即付費 NT$ 299"}
                </Button>
                <p className="text-xs text-muted-foreground">
                  * 這是一個演示版本，實際付費功能將集成真實的支付系統
                </p>
              </div>
            </div>
